% camera raw responses prediction using radial basis functions network for
% SONY ILCE7
%
...
save_dir = fullfile(config.data_path,...
                    'imaging_simulation_model\parameters_estimation\responses\ILCE7\camera_parameters_rbfn.mat');
...
for k = 1:3
    ...
    responses_val_pred = responses_predict_rbfn(params, spectra_val, g_val, T_val, DELTA_LAMBDA);
...
save_dir = fullfile(config.data_path,...
                    'imaging_simulation_model\parameters_estimation\responses\ILCE7\validation_rbfn.mat');
