...
csv_dir = fullfile(data_path.path, 'imaging_simulation_model\parameters_estimation\responses\NIKON_D3x\D65_DSG.csv');
spd_d65 = mean(xlsread(csv_dir, 1, 'AK93:PU94'), 1);
csv_dir = fullfile(data_path.path, 'imaging_simulation_model\parameters_estimation\responses\NIKON_D3x\A_DSG.csv');
spd_A = mean(xlsread(csv_dir, 1, 'AK93:PU94'), 1);
csv_dir = fullfile(data_path.path, 'imaging_simulation_model\parameters_estimation\responses\NIKON_D3x\LED_DSG.csv');
