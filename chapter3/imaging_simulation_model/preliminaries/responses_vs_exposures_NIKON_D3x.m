...
folders = fullfile(data_path.path, 'response_prediction\preliminaries\NIKON_D3x\ISO100_EXP200_to_8_F4_55mm\*.NEF');
...
save_dir = fullfile(data_path.path, 'response_prediction\preliminaries\NIKON_D3x\responses_vs_exposures_ISO100.mat');
...
folders = fullfile(data_path.path, 'response_prediction\preliminaries\NIKON_D3x\ISO800_EXP200_to_8_F4_55mm\*.NEF');
contents = dir(folders);
profile_dir = '';
exposures = zeros(numel(contents), 1);
mean_values = zeros(numel(contents), 3);
...
save_dir = fullfile(data_path.path, 'response_prediction\preliminaries\NIKON_D3x\responses_vs_exposures_ISO800.mat');
save(save_dir, 'exposures', 'mean_values');