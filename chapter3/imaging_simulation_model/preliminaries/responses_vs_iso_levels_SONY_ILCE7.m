...
folders = fullfile(data_config.path, 'response_prediction\preliminaries\ILCE7\EXP8_ISO100_to_1600_F4_55mm\*.ARW');
...
save_dir = fullfile(data_config.path, 'response_prediction\preliminaries\ILCE7\responses_vs_iso_EXP8.mat');
...
folders = fullfile(data_config.path, 'response_prediction\preliminaries\ILCE7\EXP60_ISO100_to_1600_F4_55mm\*.ARW');
contents = dir(folders);
profile_dir = '';
iso_levels = zeros(numel(contents), 1);
mean_values = zeros(numel(contents), 3);
...
save_dir = fullfile(data_config.path, 'response_prediction\preliminaries\ILCE7\responses_vs_iso_EXP60.mat');
save(save_dir, 'iso_levels', 'mean_values');
