...
% test camera responses w.r.t. different capture settings for SONY ILCE7
...
folders = fullfile(data_config.path, 'response_prediction\preliminaries\ILCE7\combined_settings_1000lx\*.ARW');
...
save_dir = fullfile(data_config.path, 'response_prediction\preliminaries\ILCE7\responses_vs_capture_settings.mat');
