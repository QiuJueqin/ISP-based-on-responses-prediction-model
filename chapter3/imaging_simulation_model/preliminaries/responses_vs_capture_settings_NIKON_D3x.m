...
folders = fullfile(config.data_path, 'response_prediction\preliminaries\NIKON_D3x\combined_settings_1000lx\*.NEF');
...
save_dir = fullfile(config.data_path, 'response_prediction\preliminaries\NIKON_D3x\responses_vs_capture_settings.mat');
