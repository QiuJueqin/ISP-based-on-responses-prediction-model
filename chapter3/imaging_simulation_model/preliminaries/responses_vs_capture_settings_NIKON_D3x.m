...
folders = fullfile(data_path.path, 'response_prediction\preliminaries\NIKON_D3x\combined_settings_1000lx\*.NEF');
...
save_dir = fullfile(data_path.path, 'response_prediction\preliminaries\NIKON_D3x\responses_vs_capture_settings.mat');
