...
folders = fullfile(config.data_path, 'response_prediction\preliminaries\ILCE7\ISO100_EXP200_to_8_F4_55mm\*.ARW');
...
save_dir = fullfile(config.data_path, 'response_prediction\preliminaries\ILCE7\responses_vs_exposures_ISO100.mat');
...
folders = fullfile(config.data_path, 'response_prediction\preliminaries\ILCE7\ISO800_EXP200_to_8_F4_55mm\*.ARW');
contents = dir(folders);
profile_dir = '';
exposures = zeros(numel(contents), 1);
mean_values = zeros(numel(contents), 3);
...
save_dir = fullfile(config.data_path, 'response_prediction\preliminaries\ILCE7\responses_vs_exposures_ISO800.mat');
save(save_dir, 'exposures', 'mean_values');
