% noise calibration for NIKON D3x
...
for i = 1:numel(folders)
    ...
    [g0_estimate, mu_estimate_concat] = estimate_g0(raw_dirs_mat);
    ...
    contents = dir(fullfile(folders{i}, 'dark\*.NEF'));
    raw_dirs = fullfile({contents.folder}, {contents.name});
    assert(numel(raw_dirs) == n3);
    mu_dark_estimate = estimate_mu_dark(raw_dirs);
