% color correction calibration for SONY ILCE7
...
for i = 1:numel(unknown_illuminant_names)
    ...
    fprintf(['> illuminant %s:\n',...
             ...
             iname,...
             mean(errs_train.(iname).ciedelab),...
             max(errs_train.(iname).ciedelab),...
             mean(errs_train.(iname).ciedelab(neutral_idx)),...
             mean(errs_val.(iname).ciedelab),...
             max(errs_val.(iname).ciedelab),...
             mean(errs_val.(iname).ciedelab(neutral_idx)));
end
